...
typedef struct {
	...
	// round-tripped through the session<N> cvar. Identity: a verified
	// client stays verified until they actually disconnect, regardless
...
typedef struct {
	...
	int			exitTime;
	qboolean	exitLogged;				// Exit event already logged for this match
