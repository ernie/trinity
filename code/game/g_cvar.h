...
G_CVAR( g_overtimelimit, "g_overtimelimit", "0", CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_NORESTART, 0, qtrue, qfalse )
...
G_CVAR( g_teamDMSpawnThreshold, "g_teamDMSpawnThreshold", "8", CVAR_ARCHIVE, 0, qfalse, qfalse )
...
#ifdef MISSIONPACK
G_CVAR( g_obeliskHealth, "g_obeliskHealth", "2500", CVAR_SERVERINFO, 0, qfalse, qfalse )
...
// derived from g_mode (BG_ModeToAxes); internal-only now, no longer on the wire
G_CVAR( g_movement, "g_movement", "0", CVAR_LATCH, 0, qfalse, qfalse )
G_CVAR( g_gameplay, "g_gameplay", "0", CVAR_LATCH, 0, qfalse, qfalse )
